...
CREATE TABLE `exercices` (
  ...
  UNIQUE KEY `idexercices_UNIQUE` (`idexercices`),
  KEY `idstudent_idx` (`idstudent`),
  CONSTRAINT `idstudentE` FOREIGN KEY (`idstudent`) REFERENCES `student` (`idstudent`)
...
INSERT INTO `exercices` VALUES (1,'A','23456',190388,'ygubhjn');
...
-- Dump completed on 2020-04-14 11:15:40
